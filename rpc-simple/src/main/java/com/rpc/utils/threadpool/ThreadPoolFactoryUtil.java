 ...
 * @Author: Eun
 * @Version 1.0.0
 * @ClassName: ThreadPoolFactoryUtil.java
 * @Description: 线程池工具类
 * @CreateTime: 2022/8/8 14:15:00
 **/
public class ThreadPoolFactoryUtil {

    private final static Logger logger = LoggerFactory.getLogger(ThreadPoolFactoryUtil.class);
    ...
    public static ExecutorService createCustomThreadPoolIfAbsent(CustomThreadPoolConfig customThreadPoolConfig, String threadNamePrefix, Boolean daemon) {
        ...
        // 如果 threadPool 被 shutdown 就重新创建一个
     ...
     * @param daemon 是否指定为 Daemon Thread （守护线程）
